...
3- to build run mvn clean install in tbd-jk folder
4- check ..\tbd-jk\provision\target\provision-1.0-SNAPSHOT\modules\system\layers\base\com\h2database\h2\main
4-1 you can see module.xml still in template form
4-2 can't find h2-1.4.200.jar although it was added to pom.xml as dependency
